...
densidadl = (round((censo_2017["14"]["Habitantes"])/(censo_2017["14"]["Superficie"])))
print(f"La densidad poblacional de la región de Los Rios es de: {densidadl:.1f}")

densidadm = (round((censo_2017["12"]["Habitantes"])/(censo_2017["12"]["Superficie"])))
print(f"La densidad poblacional de la región de Magallanes es de: {densidadm:.1f}")
